...
export const _RedeemCodeGroupState = createPgEnum('_redeem_code_group_state', E.RedeemCodeGroupState);
export const _RedeemCodeState = createPgEnum('_redeem_code_state', E.RedeemCodeState);
