...
5. 카드를 이용한 결제 후 취소 요청 시 5영업일 이내 결제된 카드로 결제 취소 처리됩니다.
6. 회사는 불법 금융행위 등을 방지하기 위하여 회원에게 환급에 필요한 증빙 서류를 요구할 수 있으며, 회원이 이를 거부할 경우에는 환급이 제한될 수 있습니다.
7. 회원이 직접 구매하지 않은 포인트는 환급대상에서 제외됩니다.
