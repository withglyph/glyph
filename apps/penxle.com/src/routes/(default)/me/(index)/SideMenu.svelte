...
<aside
  class={clsx(
    'hidden w-full max-w-81.25 bg-white border border-gray-30 rounded-2xl px-4 py-10 h-full sm:block',
    $page.url.pathname === '/me' &&
      'block! border-white max-w-screen rounded-0!',
  )}
>
    ...
    <ul>
      ...
      <li>
        <a
          class={clsx(
            'flex items-center w-full inline-block p-3 h-15 font-bold rounded-1.5 transition hover:bg-gray-5 text-gray-40',
            $page.url.pathname === '/me/interest' && 'bg-gray-5 text-gray-90',
          )}
          href="/me/interest"
        >
          관심 설정
      ...
      <li>
        <a
          class={clsx(
            'flex items-center w-full inline-block p-3 h-15 font-bold rounded-1.5 transition hover:bg-gray-5 text-gray-40',
            $page.url.pathname === '/me/preference' && 'bg-gray-5 text-gray-90',
          )}
          href="/me/preference"
        >
          필터링 설정
      ...
      <li>
        <a
          class={clsx(
            'flex items-center w-full inline-block p-3 h-15 font-bold rounded-1.5 transition hover:bg-gray-5 text-gray-40',
            $page.url.pathname === '/me/account' && 'bg-gray-5 text-gray-90',
          )}
          href="/me/account"
        >
          계정 설정
