            ...
            <div class="flex gap-3">
              <div class="flex flex-col justify-between">
                <p class="bodylong-16-m mb-2 text-secondary">
                  고행을 길을 예가 그들은 위하여 우리 목숨이 너의 그리하였는가? 물방아 꾸며 않는 못할 인도하겠다는
                  동력은 관현악이며, 무엇이 심장의 것이다. 산야에 찾아 그들의 이 예가 따뜻한 맺어, 있는 붙잡아 끓는다.
                  석가는 타오르고 천지는 용감하고 듣기만 길을 목숨이 고행을 교향악이다. 찾아 온갖 끝까지 노래하며 실로
                  아니다.
                </p>
                <div>
