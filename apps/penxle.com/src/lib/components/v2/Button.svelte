...
<svelte:element
  ...
  class={clsx(
    ...
    variant === 'tertiary' &&
      'color-gray-400 bg-gray-100 hover:bg-gray-50 focus-visible:bg-gray-50 active:shadow-[0_0_0_2px_#E4E4E7] aria-pressed:bg-gray-50 disabled:(color-gray-300 bg-gray-50 shadow-none)',
    variant === 'outline' &&
      'color-gray-500 border-(1px solid gray-200) hover:bg-gray-50 focus-visible:bg-gray-50 active:(border-gray-300 shadow-[0_0_0_2px_#E4E4E7]) aria-pressed:bg-gray-50 disabled:(color-gray-300 border-gray-100 bg-[initial] shadow-none)',
    ...
    size === 'xs' && 'p-x-0.88rem p-y-0.31rem text-11-sb rounded-1',
