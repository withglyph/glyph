...
export const Profile = builder.loadableObject('Profile', {
  ...makeLoadableObjectFields(Profiles),
  fields: (t) => ({
    id: t.exposeID('id'),
...
export const ProvisionedUser = builder.loadableObject('ProvisionedUser', {
  ...makeLoadableObjectFields(ProvisionedUsers),
  fields: (t) => ({
    id: t.exposeID('id'),
...
export const User = builder.loadableObject('User', {
  ...makeLoadableObjectFields(Users),
  fields: (t) => ({
    id: t.exposeID('id'),
    email: t.exposeString('email'),
    state: t.expose('state', { type: dbEnum(UserState) }),
    ...
    point: t.int({
      args: { kind: t.arg({ type: dbEnum(PointKind), required: false }) },
    ...
    posts: t.field({
      type: [Post],
      args: { state: t.arg({ type: dbEnum(PostState), defaultValue: 'PUBLISHED' }) },
      resolve: async (user, args) => {
    ...
    notifications: t.field({
      ...
      args: {
        ...
        category: t.arg({ type: dbEnum(UserNotificationCategory), required: false }),
      },
      resolve: async (user, args) => {
...
export const UserContentFilterPreference = builder.loadableObject('UserContentFilterPreference', {
  ...makeLoadableObjectFields(UserContentFilterPreferences),
  fields: (t) => ({
    id: t.exposeID('id'),
    category: t.expose('category', { type: dbEnum(ContentFilterCategory) }),
    action: t.expose('action', { type: dbEnum(ContentFilterAction) }),
  }),
});

export const UserEmailVerification = builder.loadableObject('UserEmailVerification', {
  ...makeLoadableObjectFields(UserEmailVerifications),
  fields: (t) => ({
    id: t.exposeID('id'),
    kind: t.expose('kind', { type: dbEnum(UserEmailVerificationKind) }),
    email: t.exposeString('email'),
    expiresAt: t.expose('expiresAt', { type: 'DateTime' }),
  }),
});

export const UserMarketingConsent = builder.loadableObject('UserMarketingConsent', {
  ...makeLoadableObjectFields(UserMarketingConsents),
  fields: (t) => ({
    id: t.exposeID('id'),
...
export const UserNotificationPreference = builder.loadableObject('UserNotificationPreference', {
  ...makeLoadableObjectFields(UserNotificationPreferences),
  fields: (t) => ({
    id: t.exposeID('id'),
    category: t.expose('category', { type: dbEnum(UserNotificationCategory) }),
    method: t.expose('method', { type: dbEnum(UserNotificationMethod) }),
    opted: t.exposeBoolean('opted'),
  }),
});

export const UserPersonalIdentity = builder.loadableObject('UserPersonalIdentity', {
  ...makeLoadableObjectFields(UserPersonalIdentities),
  fields: (t) => ({
    id: t.exposeID('id'),
    name: t.exposeString('name'),
...
export const UserSingleSignOn = builder.loadableObject('UserSingleSignOn', {
  ...makeLoadableObjectFields(UserSingleSignOns),
  fields: (t) => ({
    id: t.exposeID('id'),
    provider: t.expose('provider', { type: dbEnum(UserSingleSignOnProvider) }),
    email: t.exposeString('email'),
  }),
});

export const UserSettlementIdentity = builder.loadableObject('UserSettlementIdentity', {
  ...makeLoadableObjectFields(UserSettlementIdentities),
  fields: (t) => ({
    id: t.exposeID('id'),
...
export const UserWithdrawalConfig = builder.loadableObject('UserWithdrawalConfig', {
  ...makeLoadableObjectFields(UserWithdrawalConfigs),
  fields: (t) => ({
    id: t.exposeID('id'),
...
export const UserEventEnrollment = builder.loadableObject('UserEventEnrollment', {
  ...makeLoadableObjectFields(UserEventEnrollments),
  fields: (t) => ({
    id: t.exposeID('id'),
...
const IssueUserSingleSignOnAuthorizationUrlInput = builder.inputType('IssueUserSingleSignOnAuthorizationUrlInput', {
  fields: (t) => ({
    ...
    provider: t.field({ type: dbEnum(UserSingleSignOnProvider) }),
  }),
});
...
const UpdateUserContentFilterPreferenceInput = builder.inputType('UpdateUserContentFilterPreferenceInput', {
  fields: (t) => ({
    category: t.field({ type: dbEnum(ContentFilterCategory) }),
    action: t.field({ type: dbEnum(ContentFilterAction) }),
  }),
});
...
const UpdateUserNotificationPreferenceInput = builder.inputType('UpdateUserNotificationPreferenceInput', {
  fields: (t) => ({
    category: t.field({ type: dbEnum(UserNotificationCategory) }),
    method: t.field({ type: dbEnum(UserNotificationMethod) }),
    opted: t.boolean(),
  }),
});
