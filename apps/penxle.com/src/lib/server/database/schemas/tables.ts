...
export const PostComments = pgTable(
  'post_comments',
  {
    ...
    state: E.PostCommentState('state').notNull(),
    visibility: E.PostCommentVisibility('visibility').notNull(),
...
export const RevenueWithdrawals = pgTable('revenue_withdrawals', {
  ...
  txId: text('tx_id'),
  kind: E.RevenueWithdrawalKind('kind').notNull(),
  state: E.RevenueWithdrawalState('state').notNull().default('PENDING'),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
});
...
export const PostTags = pgTable(
  'post_tags',
  {
    ...
    tagId: text('tag_id')
      .notNull()
      .references(() => Tags.id),
    kind: E.PostTagKind('kind').notNull(),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
  },
...
export const PointTransactions = pgTable('point_transactions', {
  ...
  userId: text('user_id')
    .notNull()
    .references(() => Users.id),
  cause: E.PointTransactionCause('cause').notNull(),
...
export const Spaces = pgTable(
  'spaces',
  {
    ...
    visibility: E.SpaceVisibility('visibility').notNull(),
    state: E.SpaceState('state').notNull(),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
  },
...
export const SpaceMembers = pgTable(
  'space_members',
  {
    ...
    profileId: text('profile_id')
      .notNull()
      .references(() => Profiles.id),
    state: E.SpaceMemberState('state').notNull(),
    role: E.SpaceMemberRole('role').notNull(),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
  },
...
export const SpaceCollections = pgTable('space_collections', {
  ...
  name: text('name').notNull(),
  state: E.SpaceCollectionState('state').notNull(),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
});
...
export const PostRevisions = pgTable(
  'post_revisions',
  {
    ...
    price: integer('price'),
    kind: E.PostRevisionKind('kind').notNull(),
    title: text('title'),
...
export const SpaceMemberInvitations = pgTable('space_member_invitations', {
  ...
  role: E.SpaceMemberRole('role').notNull(),
  state: E.SpaceMemberInvitationState('state').notNull(),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
...
export const Posts = pgTable(
  'posts',
  {
    ...
    state: E.PostState('state').notNull(),
    ...
    ageRating: E.PostAgeRating('age_rating').notNull().default('ALL'),
...
export const Revenues = pgTable('revenues', {
  ...
  userId: text('user_id')
    ...
    .references(() => Users.id),
  targetId: text('target_id'),
  state: E.RevenueState('state').notNull(),
  kind: E.RevenueKind('kind').notNull(),
  amount: integer('amount').notNull(),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
...
export const Users = pgTable(
  'users',
  {
    ...
    profileId: text('profile_id')
      ...
      .unique()
      .references(() => Profiles.id),
    state: E.UserState('state').notNull(),
    role: E.UserRole('role').notNull().default('USER'),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
  },
...
export const UserNotifications = pgTable(
  'user_notifications',
  {
    ...
    category: E.UserNotificationCategory('category').notNull(),
    state: E.UserNotificationState('state').notNull(),
    data: jsonb('data'),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
...
export const UserEmailVerifications = pgTable('user_email_verifications', {
  ...
  code: text('code'),
  kind: E.UserEmailVerificationKind('kind').notNull(),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
  expiresAt: datetime('expires_at').notNull(),
...
export const UserNotificationPreferences = pgTable(
  'user_notification_preferences',
  {
    ...
    userId: text('user_id')
      ...
      .references(() => Users.id),
    category: E.UserNotificationCategory('category').notNull(),
    method: E.UserNotificationMethod('method').notNull(),
...
export const UserSingleSignOns = pgTable(
  'user_single_sign_ons',
  {
    ...
    userId: text('user_id')
      .notNull()
      .references(() => Users.id),
    provider: E.UserSingleSignOnProvider('provider').notNull(),
...
export const UserContentFilterPreferences = pgTable(
  'user_content_filter_preferences',
  {
    ...
    userId: text('user_id')
      .notNull()
      .references(() => Users.id),
    category: E.ContentFilterCategory('category').notNull(),
    action: E.ContentFilterAction('action').notNull(),
    createdAt: datetime('created_at')
      .notNull()
      .default(sql`now()`),
  },
...
export const UserPersonalIdentities = pgTable('user_personal_identities', {
  ...
  ci: text('ci').notNull(),
  kind: E.UserPersonalIdentityKind('kind').notNull().default('PHONE'),
  createdAt: datetime('created_at')
    .notNull()
    .default(sql`now()`),
});
...
export const ProvisionedUsers = pgTable('provisioned_users', {
  ...
  token: text('token').notNull().unique(),
  email: text('email').notNull(),
  provider: E.UserSingleSignOnProvider('provider'),
